...
from modelo import Clientes
from modelo import Proyecto

from modelo import ProyectoBO
...
class MantTelefonos():
    ...
    def enviarInformacion(self):
        try:
            self.telefonoBo = TelefonosBO.TelefonosBO() 
    ...
    def consultarNombre(self):
        try:
            ...
            self.persona.cedula.set(self.telefono.cedula.get())
    ...
    def cargarTodaInformacion(self):
        try:
            self.telefonosBo = TelefonosBO.TelefonosBO() 
