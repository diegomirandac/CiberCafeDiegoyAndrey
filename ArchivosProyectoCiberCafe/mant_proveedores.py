...
#from modelo import ProveedorsBO
from modelo import ClientoBO

class MantProveedors():
    ...
    def __init__(self, parent):
        ...
        self.raiz.title ("Mantenimiento de proveedor")
        ...
        #*************************************************************************
        self.proveedor = Proveedor.Proveedor() #se crea el objeto de dominio para guardar la información
        ...
        self.txt_cedula = Entry(self.raiz, textvariable=self.proveedor.cedula, justify="right", width=12)
        ...
        #coloca en el formulario el campo y el label de proveedor
        self.lb_proveedor = Label(self.raiz, text = "Proveedor:")
        self.lb_proveedor.place(x = 240, y = 120)
        self.txt_proveedor = Entry(self.raiz, textvariable=self.proveedor.proveedor, justify="right", width=30)
        self.txt_proveedor.place(x = 370, y = 120)
        ...
        self.txt_descripcion = Entry(self.raiz, textvariable=self.proveedor.descripcion, justify="right", width=30)
        ...
        self.sheet = Sheet(self.raiz,
                            ...
                            headers = ['Cédula', 'Nombre', 'Proveedor', 'Descripción'],
    ...
    def enviarInformacion(self):
        try:
            self.proveedorBo = ProveedorsBO.ProveedorsBO() #se crea un objeto de logica de negocio
    ...
    def limpiarInformacion(self):
        self.proveedor.limpiar() #llama al metodo de la clase cliente para limpiar los atritudos de la clase
        self.nombreCliente.set("")
        self.insertando = True
    ...
    def consultarNombre(self):
        try:
            ...
            self.cliente.Cedula.set(self.proveedor.Cedula.get()) #setea la cédula de la cliente
    ...
    def cargarTodaInformacion(self):
        try:
            self.proveedorsBo = ProveedorsBO.ProveedorsBO() #se crea un objeto de logica de negocio
            resultado = self.proveedorsBo.consultar()
    ...
    def cargarInformacion(self):
        try:
            ...
            proveedor = (self.sheet.get_cell_data(datoSeleccionado[0],2))
            self.proveedor.proveedor.set(proveedor)
            self.proveedorBo = ProveedorsBO.ProveedorsBO() #se crea un objeto de logica de negocio
            self.proveedorBo.consultarProveedor(self.proveedor) #se envia a consultar
    ...
    def eliminarInformacion(self):
        try:
            ...
            resultado = msg.askquestion("Eliminar",  "¿Desear eliminar el proveedor "+proveedor+" de "+nombre+" de la base de datos?")
            if resultado == "yes":
                self.proveedor.proveedor.set(proveedor)
                self.proveedorBo = ProveedorsBO.ProveedorsBO() #se crea un objeto de logica de negocio
                self.proveedorBo.eliminar(self.proveedor) #se envia a consultar
                self.cargarTodaInformacion()
                self.proveedor.limpiar()
                self.nombreCliente.set("")
