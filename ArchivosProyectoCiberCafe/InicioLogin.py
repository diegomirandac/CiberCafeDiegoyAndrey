...
def ventana_inicio():
    ...
    ventana_principal.title("Login CafeInternet")
    Label(text="Registro Administrador", bg="yellow", width="300", height="2", font=("Calibri", 13)).pack()
    Label(text="").pack()
...
def registro():
    ...
    Label(ventana_registro, text="Ingrese sus datos", bg="yellow").pack()
    ...
    entrada_clave.pack()
    Label(ventana_registro, text="").pack()
    Button(ventana_registro, text="Registrarse", width=10, height=1, bg="yellow", command = registro_usuario).pack() 
...
def registro_usuario():
    ...
    Label(ventana_registro, text="Se pudo registrar", fg="orange", font=("calibri", 11)).pack()
